...
　　当<img src="https://latex.codecogs.com/gif.latex?\inline&space;\small&space;\frac{1}{2}\epsilon^{2}g^{\top}Hg" title="\small \frac{1}{2}\epsilon^{2}g^{\top}Hg" />超过<img src="https://latex.codecogs.com/gif.latex?\inline&space;\small&space;\epsilon&space;g^{\top}g"/>时，
