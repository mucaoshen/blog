...
　　在实践中，一般会显示衰减学习率知道第τ次迭代：<a><img src="https://latex.codecogs.com/gif.latex?\inline&space;\small&space;\epsilon_{k}=(1-\alpha)\epsilon_{0}&space;&plus;&space;\alpha\epsilon_{\tau}" title="\small \epsilon_{k}=(1-\alpha)\epsilon_{0} + \alpha\epsilon_{\tau}" /></a>，其中<a><img src="https://latex.codecogs.com/gif.latex?\inline&space;\small&space;\alpha=\frac{k}{\tau}" title="\small \alpha=\frac{k}{\tau}" /></a>
在τ次迭代后，一般使ε保持常数。
